...
public class DemoController {
  ...
  public Item getItemById(@RequestParam String id) {
    return itemGateway.getItemById(ItemChannels.API_HEADER_VALUE_GET_ITEM_BY_ID,
        StringUtils.defaultString(id));
  }

  @PostMapping(path = "/item")
  public ApiResponseMessage addNewItem(@RequestBody Item item) {
    return itemGateway.addNewItem(ItemChannels.API_HEADER_VALUE_ADD_NEW_ITEM, item);
  }

  @PutMapping(path = "/item")
  public ApiResponseMessage updateItemById(@RequestBody Item item) {
